...
struct CarDataToShow{
    ...
    init() {
        ...
        sections = ["REGISTRATION NR", "PRODUCTION BRAND", "MODEL", "COLOR", "CHASIS NR.", "PRODUCTION YEAR", "MODEL YEAR", "FIRST REGISTRATION", "ORIGIN", "TAX", "CAR STATUS", "UPPLYSNINGAR", "MILEAGE", "LAST CHECK", "NEXT CHECK", "GEARBOX", "FUEL", "TRACTION", "CAR TYPE", "CHASIS", "ENGINE CAPACITY", "ENGINE POWER", "TOP SPEED", "CITY", "OUTSIDE CITY", "OVERALL CONSUMPTION"]
